  ...
  ({ className, type, ...props }, ref) => {
    ...
    return (
      <input
        ...
        onBlur={handleBlur}
        className={cn(
          "flex h-11 w-full rounded-xl border border-white/20 bg-white/10 px-4 py-2 text-base ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50 focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 transition-all hover:bg-white/15 hover:border-white/40 md:text-sm",
          className
        )}
        ref={ref}
      />
