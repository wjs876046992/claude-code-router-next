...
export interface Provider {
  ...
  // "low" | "medium" | "high", a custom token budget (number), a free-form
  // provider effort string (e.g. "minimal"), or unset/empty to follow the
  // client.
  default_thinking_level?: string | number;
